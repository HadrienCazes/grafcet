...
public class HadrienSecondaryA extends Brain {
  //---PARAMETERS---//
  ...
  private static final int DETECTED = 4;
  ...
  // DEBUGGING VARIABLE
  private String nameWhoAmI;

  //---CONSTRUCTORS---//
  public HadrienSecondaryA() { super(); }
  ...
  public void activate() {
    ...
    //DEBUGGING PURPOSE
    if (whoAmI==ROCKY) nameWhoAmI = "ROCKY";
    if (whoAmI==UNDEFINED) nameWhoAmI = "MARIO";
  ...
  public void step() {
    ...
    for (IRadarResult o: detectRadar()){
      if (o.getObjectType()==IRadarResult.Types.OpponentMainBot || o.getObjectType()==IRadarResult.Types.OpponentSecondaryBot) {
        ...
        fallbackOrder = true;
        // DEBUGGING PURPOSE
        //System.out.println("I AM: "+ nameWhoAmI + " AND I DETECTED ENEMY " + o.getObjectType()+ " at ("+ enemyX +","+ enemyY + ")");
        //System.out.println("***********************************************************************************");
      }
    ...
    // ADDED
    if (state==DETECTED && (detectFront().getObjectType()== IFrontSensorResult.Types.OpponentMainBot || detectFront().getObjectType()==IFrontSensorResult.Types.OpponentSecondaryBot)){
      isMovingBack = true;
      myMoveBack();
      return;
    }
