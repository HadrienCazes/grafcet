...
public class Parameters {
  ...
  //---TEAM-A-PARAMETERS---//
  //-----------------------//
  public static final String teamAMainBotBrainClassName = "algorithms.HadrienMain"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.HadrienSecondary"; //class given by name; is supposed to extends robotsimulator.Brain
