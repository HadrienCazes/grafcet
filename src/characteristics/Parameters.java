...
public class Parameters {
  ...
  //---TEAM-A-PARAMETERS---//
  //-----------------------//
  public static final String teamAMainBotBrainClassName = "algorithms.Hadrien1MainA"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.Hadrien1SecondaryA"; //class given by name; is supposed to extends robotsimulator.Brain
