...
public class Parameters {
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.Stage7SecondaryA"; //class given by name; is supposed to extends robotsimulator.Brain
