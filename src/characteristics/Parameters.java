...
public class Parameters {
  ...
  public static final String teamBMainBotBrainClassName = "algorithms.Stage1SecondaryA"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.Stage1SecondaryA"; //class given by name; is supposed to extends robotsimulator.Brain
