...
public class Parameters {
  ...
  //---TEAM-A-PARAMETERS---//
  //-----------------------//
  public static final String teamAMainBotBrainClassName = "algorithms.HadrienMainA"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.HadrienSecondaryA"; //class given by name; is supposed to extends robotsimulator.Brain
